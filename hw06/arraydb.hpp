/*
    ...
    This is the arraydb template class with error handling. This class defines 
    a dynamic array that tracks the size of the array and the values of its 
    members, which can be any type. This class includes constructors, 
    destructors, and overloaded operators. It also includes a function to 
